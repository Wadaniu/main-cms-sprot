...
class BasketballMatchInfo extends Model
{
    protected $pk = 'match_id';
    protected $connection = 'compDataDb';
    const SyncLimit = 30;
    const SyncMatchInfoKey = 'syncBasketballMatchInfoList';
    ...
    public function autoSync(){
        ...
        $BasketballMatchCount = new \app\commonModel\BasketballMatchCount();
        foreach ($matchIds as $matchId){
            $analysis = $BasketballMatchCount->getMatchAnalysis($matchId);
            $players = $BasketballMatchCount->getMatchPlayers($matchId);
            $videos = $BasketballMatchCount->getMatchVideoCollection($matchId);
...
//        $updateId = $BasketballMatchCount->getChangeData(3);
//        //获取视频更新Id
...
//        }
    ...
    public function addMatchByLast()
    {
        ...
        $matchIds = Db::connect('compDataDb')->name('basketball_match')

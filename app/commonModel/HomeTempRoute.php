...
class HomeTempRoute extends Model
{
    /**
    * 获取分页列表
    * @param $where
    * @param $param
    */
    public function getHomeTempRouteList($where, $param)
    {
    ...
    * @param $param
    */
    public function addHomeTempRoute($param)
    {
		$insertId = 0;
        try {
    ...
    * @param $param
    */
    public function editHomeTempRoute($param)
    {
        try {
    ...
    * @return array
    */
    public function delHomeTempRouteById($id,$type=0)
    {
		if($type==0){
			//逻辑删除
			try {

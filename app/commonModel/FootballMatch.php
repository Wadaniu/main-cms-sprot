...
class FootballMatch extends Model
{
    ...
    */
    public function getFootballMatchList($where, $param)
    {
        ...
        $list = self::where($where)
            ->field('id,season_id,home_team_id,away_team_id,status_id,match_time,neutral,note,home_scores,away_scores,home_position,away_position,coverage,venue_id,referee_id,related_id,agg_score,round,environment,updated_at,comp,home,away,mobile_link,pc_link,type,title,cover,duration,forecast')
            ->order($order)
    ...
    */
    ...
    public function getTodayData($competitionIds = [],$status = [1,2,3,4,5,7,8],$limit = 0){
    ...
    {
        $info = self::field('id,is_link,mobile_link,pc_link,competition_id,home_team_id,away_team_id')->where('id', $id)->where('status_id','IN',[1,2,3,4,5,7])->findOrEmpty();
        return $info;
    }

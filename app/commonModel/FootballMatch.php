    ...
    */
    public function getFootballMatchList($where, $param)
    {
        ...
        $list = self::where($where)
            ->field('id,season_id,home_team_id,away_team_id,status_id,match_time,neutral,note,home_scores,away_scores,home_position,away_position,coverage,venue_id,referee_id,related_id,agg_score,round,environment,updated_at,comp,home,away,mobile_link,pc_link,title,cover,duration,forecast')
            ->order($order)
